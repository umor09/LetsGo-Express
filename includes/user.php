<?php
	Class User {
		...
		protected static $db_fields=array('id', 'service_point_id', 'user_name', 'password', 'email', 'phone' ,'user_type', 'status', 'full_name' ,'mailing_address' ,'entry_by' ,'entry_date' );

		public static function find_all(){
		return self::find_by_sql("select * from ".self::$table_name);
		}
		
		public static function find_client_user($user_type){
		return self::find_by_sql("select * from ".self::$table_name." where user_type={$user_type} ");
		}
