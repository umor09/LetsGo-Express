<?php
	Class Bill {
		...
		protected static $table_name="bill";
		
		protected static $db_fields=array('id' ,'booking_id' ,'bill_amount' ,'vat_tax' ,'discount' ,'total_amount' ,'paid_amount' ,'payment_type' ,'bank_name' ,'invoice_no' ,'payment_date' ,'entry_by' ,'entry_date' );
		...
		public static function calculate_discount($bill_amount, $discount){
			$discount_amount = ($bill_amount*$discount)/100;
			return $discount_amount;
		}
		
		public static function calculate_vat($bill_amount, $vat){
