<?php
	Class Booking {
		...
		protected static $db_fields=array('id' ,'service_point_id' ,'customer_id' ,'request_time' ,'collected_time' , 'collected_by','delivery_classes','booking_status', 'approve_by', 'approve_date', 'delivery_status', 'entry_by' ,'entry_date' );
