...
<title><?php echo $title;?>Create Invoice</title>
                ...
                <div id="div-1" class="body">
                  <form class="form-horizontal" name="bookingreceivefrm" method="post" action="">
                    <div class="form-group">
                      ...
                      <div class="checkbox">
                        <label>
                          <input class="uniform" type="radio" name="booking_status" checked="checked" value="Request" onClick="bookingreceivefrm.submit()" <?php if(isset($search_status) && $search_status=="Request") { echo "checked='checked'";} ?> />
                          Request </label>
                        <label>
                          <input class="uniform" type="radio" name="booking_status" value="Booked" onClick="bookingreceivefrm.submit()" <?php if(isset($search_status) && $search_status=="Booked") { echo "checked='checked'";} ?> />
                          Booked </label>
                      </div>
                    </div>
                    <!-- /.form-group -->
                  ...
                  <table id="dataTable" width="100%" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a data-toggle="modal" class="paymentModal" data-id="<?php echo $booking_id; ?>" data-original-title="Payment" data-placement="bottom" data-target="#detailsModal"> <em class="fa fa-list-alt"></em>&nbsp;Payment</a>&nbsp;|&nbsp; <a data-toggle="modal" class="printModal" data-id="<?php echo $booking_id; ?>" data-original-title="Print" data-placement="bottom" data-target="#printModal"> <em class="fa fa-print"></em>&nbsp;Print</a></td>
                      </tr>
                      <?php
                }
                ?>
...
<script>
    $('.detailsModal').click(function(){
	 ...
	 $('.paymentModal').click(function(){
        var ID=$(this).attr('data-id');
		//alert(ID);
        $.ajax({url:"bill_pay.php?ID="+ID,cache:false,success:function(result){
            $(".modal-body").html(result);
        }});	
    });
        ...
        var ID=$(this).attr('data-id');
		var page = "print_booking.php?ID="+ID;
