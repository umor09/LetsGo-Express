...
<html>
    ...
    <link rel="stylesheet" href="assets/ajax/libs/uniform/uniform.default.min.css">
    <link rel="stylesheet" href="assets/ajax/libs/chosen/chosen.min.css">
    <link rel="stylesheet" href="assets/ajax/libs/jquery-tagsinput/jquery.tagsinput.css">
    <link rel="stylesheet" href="assets/ajax/libs/jasny-bootstrap/jasny-bootstrap.min.css">
    <link rel="stylesheet" href="assets/ajax/libs/bootstrap-switch/bootstrap-switch.min.css">
    <link rel="stylesheet" href="assets/ajax/libs/bootstrap-datepicker/datepicker3.min.css">
    <link rel="stylesheet" href="assets/ajax/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.css">
    <link rel="stylesheet" href="assets/ajax/libs/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css">
    ...
    <div class="outer">
        ...
        <div class="row">
            ...
            <div class="box dark">
                ...
                <!-- .toolbar -->
                <div class="toolbar">
                      <nav style="padding: 8px;"> <a href="javascript:;" class="btn btn-default btn-xs collapse-box"> <i class="fa fa-minus"></i> </a> <a href="javascript:;" class="btn btn-default btn-xs full-box"> <i class="fa fa-expand"></i> </a> <a href="javascript:;" class="btn btn-danger btn-xs close-box"> <i class="fa fa-times"></i> </a> </nav>
                    </div>
                <!-- /.toolbar --> 
              </header>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="col-lg-8">
                        ...
                        <label>
                          ...
                          <div class="checkbox">
                        <label>
                              <input class="uniform" type="checkbox" value="option2">
                              Unchecked checkbox </label>
                      </div>
                          <div class="checkbox">
                        <label>
                              <input class="uniform" type="checkbox" value="option3" checked disabled>
                              Disabled
                              checked </label>
                      </div>
                          <div class="checkbox">
                        <label>
                              <input class="uniform" type="checkbox" value="option2" disabled>
                    ...
                    <div class="col-lg-8">
                          <div class="checkbox">
                        <label>
                              <input class="uniform" type="radio" name="optionsRadios" value="option1" checked>
                              Checked
                              radio </label>
                      </div>
                          <!-- /.checkbox -->
                          <div class="checkbox">
                        <label>
                              <input class="uniform" type="radio" name="optionsRadios" value="option2">
                              Unchecked
                              radio </label>
                      </div>
                          <!-- /.checkbox -->
                        ...
                        <label>
                              ...
                              Disabled unchecked radio </label>
                      </div>
                          <!-- /.checkbox --> 
                        </div>
                  </div>
                    ...
                    <div class="col-lg-8">
                          <input class="make-switch" type="checkbox" data-size="mini" checked>
                          <br>
                          <input class="make-switch" type="checkbox" data-size="small">
                          <br>
                          <input class="make-switch" type="checkbox" data-size="normal" checked>
                          <br>
                          <input class="make-switch" type="checkbox" data-size="large">
                          <br>
                          <input class="make-switch" type="checkbox" data-label-text="BS" checked disabled>
                          <br>
                          <input class="make-switch" type="checkbox">
                          <br>
                          <input class="make-switch" type="checkbox" checked>
                          <br>
                        </div>
                  </div>
                      <div class="form-group">
                    ...
                    <div class="col-lg-8">
                          <input class="make-switch" type="checkbox" data-on-text="1" data-off-text="0" checked>
                          <br>
                          <input class="make-switch" type="checkbox" data-on-color="info" data-off-color="success">
                          <br>
                          <input class="make-switch" type="checkbox" data-on-text="osman" data-off-text="nuri" checked>
                          <br>
                          <input class="make-switch" type="checkbox" data-on-color="warning" data-off-color="danger">
                          <br>
                          <input class="make-switch" type="checkbox" data-on-text="TRUE" data-off-text="FALSE" checked>
                          <br>
                          <input class="make-switch" type="checkbox" data-on-color="default" data-off-color="primary">
                          <br>
                        </div>
                  </div>
            ...
            <div class="box">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="col-lg-5">
                        ...
                        <span class="input-group-addon">99/99/9999</span> </div>
                        </div>
                  </div>
                      <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        ...
                        <span class="input-group-addon">(999) 999-9999</span> </div>
                        </div>
                  </div>
                      <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        ...
                        <span class="input-group-addon">a*-999-a999</span> </div>
                        </div>
                  </div>
                      <div class="form-group">
                    <label class="control-label col-lg-3">Phone</label>
                    <div class="col-lg-5">
                        ...
                        <span class="input-group-addon">+33 999 999 999</span> </div>
                        </div>
                  </div>
                      <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        ...
                        <span class="input-group-addon">99%</span> </div>
                        </div>
                  </div>
                    </form>
              </div>
        ...
        <div class="row"> 
            ...
            <div class="box">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="col-lg-3"> <a href="#" class="btn btn-danger" id="cp4" data-color-format="hex"
                               data-color="rgb(255, 255, 255)">Change background color</a> </div>
                  </div>
                    </form>
              </div>
                  <!-- /.BODY --> 
            ...
            <div class="box">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="col-lg-3">
                        ...
                        <span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span> </div>
                        </div>
                  </div>
                      <div class="form-group">
...
<script src="assets/ajax/libs/moment/moment.min.js"></script> 
<script src="assets/ajax/libs/uniform/jquery.uniform.min.js"></script> 
<script src="assets/ajax/libs/chosen/chosen.jquery.min.js"></script> 
<script src="assets/ajax/libs/jquery-tagsinput/jquery.tagsinput.min.js"></script> 
<script src="assets/ajax/libs/autosize/jquery.autosize.min.js"></script> 
<script src="assets/ajax/libs/jasny-bootstrap/jasny-bootstrap.min.js"></script> 
<script src="assets/ajax/libs/bootstrap-switch/bootstrap-switch.min.js"></script> 
<script src="assets/ajax/libs/bootstrap-datepicker/bootstrap-datepicker.min.js"></script> 
<script src="assets/ajax/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.js"></script> 
<script src="assets/ajax/libs/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js"></script> 
